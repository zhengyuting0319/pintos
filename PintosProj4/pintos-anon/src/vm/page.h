...
#define ON_FRAME 0x1
#define ON_SWAP  0x2
#define FROM_FILESYS 0x3


#define MAX_STACK_SIZE 0x800000 //the max stack size
/**
...
bool vm_load_page(struct supplemental_page_table_entry *spte, uint32_t *pagedir, void *upage);
