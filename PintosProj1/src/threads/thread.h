...
struct thread
  {
    ...
    int64_t ticks_blocked;              /* ticks thread still need to sleep */
    int original_priority;              /* if donate, record the original priority, else same with priority */
